...
public class BrowseMoviesController extends InteractiveViewController {
    public BrowseMoviesController(View view){
        ...
        this.requestLoggedInUserInputMessage = "Please type the number of the movie you want to check out or type an option from the Navigation Bar, then hit Enter:";
